...
export default function AdminPage({ onExit }: { onExit: () => void }) {
  ...
  if (!token) {
    return (
      <div className="min-h-screen bg-luxury-black flex items-center justify-center px-6">
        <div className="w-full max-w-sm bg-white/5 border border-gold/20 rounded-[2rem] p-6 shadow-[0_0_40px_rgba(212,168,83,0.15)] backdrop-blur">
  ...
  return (
    <div className="min-h-screen bg-luxury-black text-white">
      <div className="max-w-6xl mx-auto min-h-screen bg-luxury-black relative">
        <div className="sticky top-0 z-20 bg-white/5 border-b border-white/10 px-5 py-3 flex items-center justify-between backdrop-blur">
