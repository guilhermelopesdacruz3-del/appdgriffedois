      ...
      <div className="px-5 pt-5">
        ...
        <div className="flex gap-3 mb-4">
          ...
          <button onClick={async () => {
            ...
            const titulo = product.name || "Ótica D'Griffe";
            const texto = `Confira ${titulo} na D'Griffe!`;
            try {
              if (navigator.share) {
          ...
          }} className="flex-1 h-12 rounded-2xl border border-gold/30 text-gold text-xs font-semibold transition-all hover:bg-gold/5 flex items-center justify-center gap-2">
