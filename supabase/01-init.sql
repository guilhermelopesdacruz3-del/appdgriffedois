-- ===========================================================================
-- Loja Integrada Conectada · Init completo (schema + seed do admin)
-- COLE TUDO NO SQL EDITOR DO SUPABASE E CLIQUE EM RUN.
-- Roda como dono do projeto (bypassa RLS), então o insert em admin_users funciona.
-- ===========================================================================
...
-- ====================== Registra o admin ======================
-- Troque o e-mail abaixo se criar outro usuário em Authentication → Users.
insert into public.admin_users (user_id)
select id from auth.users
where email = 'guilhermelopesdacruz3@gmail.com'
on conflict (user_id) do nothing;

-- Confirmação (aparece no resultado do Run):
