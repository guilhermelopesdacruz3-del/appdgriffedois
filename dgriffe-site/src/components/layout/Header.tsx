        ...
        <div className="container-site">
          <div className="flex items-center justify-between h-16 md:h-18">
            ...
            <Link to="/" className="flex items-center gap-2.5">
              <div className="w-9 h-9 md:w-10 md:h-10 bg-luxury-black rounded-full flex items-center justify-center shadow-lg shadow-luxury-black/20">
                <span className="text-gold font-display font-bold text-sm md:text-base">D</span>
              </div>
